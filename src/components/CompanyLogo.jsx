...
const CompanyLogo = () => {
  ...
  return (
    <div className="w-full container mx-auto py-20 overflow-hidden flex flex-col sm:flex-row sm:items-center items-start ">
      <div className="w-[300px] shrink-0 px-10 text-draftBlueDark border-l-4 border-yellow-600 bg-white py-2 z-10 sm:text-base text-xl font-semibold sm:text-left  mb-8 sm:mb-0">
        Fier de collaborer <br /> Avec nos partenaires
      </div>
