...
const Footer = () => {
  const footerLinks = {
    ...
    getHelp: [
      { name: 'Support Projets', href: '#' },
      { name: 'Assistance 24h/24', href: '#' },
      { name: 'Chat Rapide', href: '#' },
    ],
    support: [
      { name: 'FAQ', href: '#' },
      ...
      <div className="section-container">
        ...
        >
          ...
          >
            ...
            >
              <div className="w-4 h-4 bg-draftBlueDark rounded-full opacity-75"></div>
              <div className="w-4 h-4 bg-yellow-600 rounded-full -ml-2"></div>
              <span className="text-xl ml-1 font-extrabold">DRAFT UP CONSULTING</span>
            </motion.div>
            <motion.p 
              variants={fadeIn('up', 0.6)}
              className="text-gray-600 mb-6"
            >
              Accompagnons vos projets à fort impact en Afrique avec rigueur et innovation.
            </motion.p>
            <motion.div 
        ...
        >
          ...
          >
            ...
            >
              Copyright © {new Date().getFullYear()} Draft Up Consulting
            </motion.p>
          </motion.div>
        </motion.div>
      </div>
